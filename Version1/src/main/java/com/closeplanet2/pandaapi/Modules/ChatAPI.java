...
public class ChatAPI {
    ...
    private static void CreateMessageChannel(UUID channelUUID, String channelName, List<Player> inChannel, boolean defaultChannel, boolean receiveDefaultMessages, String messagePrefix,
        ...
        ConsoleAPI.SendConsoleMessage(PandaAPI.pandaPrefix + ChatColor.GREEN + "Message Channel has been created: " + ChatColor.BOLD + channelName);
    }
    ...
    public static void DeleteMessageChannel(String channelName){
        ...
        ConsoleAPI.SendConsoleMessage(PandaAPI.pandaPrefix + ChatColor.RED + "Message Channel has been deleted: " + ChatColor.BOLD + channelName);
    }
    ...
    public static void AddPlayerToChannel(Player player, String messageChannelName){
        ...
        ConsoleAPI.SendConsoleMessage(PandaAPI.pandaPrefix + ChatColor.GREEN + "Player has been added to message Channel:" + ChatColor.BOLD +
