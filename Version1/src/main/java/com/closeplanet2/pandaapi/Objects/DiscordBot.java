...
public class DiscordBot {
    ...
    public DiscordBot(String botName, String token, Activity botActivity){
        ...
        try{
            ...
            jda.awaitReady();
            PandaAPI.pandaAPI.SendConsoleMessage(PandaAPI.pandaPrefix + ChatColor.GREEN + "Connected Bot: " + ChatColor.BOLD + botName);
        }catch (LoginException | InterruptedException e) {
            e.printStackTrace();
            PandaAPI.pandaAPI.SendConsoleMessage(PandaAPI.pandaPrefix + ChatColor.RED + "Failed to connect bot: " + ChatColor.BOLD + botName);
        }
    }
