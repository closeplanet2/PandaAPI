...
public class CameraPath implements ConfigAPI.SaveableConfig {
    ...
    @Override
    public void SaveData(ServerConfig serverConfig, String startPath) {

    }

    @Override
    public void LoadData(ServerConfig serverConfig, String startPath) {
