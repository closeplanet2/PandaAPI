...
public class PlayerPunishments {
    ...
    private HashMap<Date, Punishment> playerPunishments;

    public PlayerPunishments(Player player){
        playerUUID = player.getUniqueId();
        playerPunishments = new HashMap<>();
    }

    public PlayerPunishments(ServerConfig serverConfig){
        playerPunishments = new HashMap<>();
    ...
    private void LoadData(ServerConfig serverConfig){
