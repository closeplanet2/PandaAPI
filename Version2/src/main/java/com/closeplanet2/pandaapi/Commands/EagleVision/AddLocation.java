...
public class AddLocation implements CommandExecutor, PandaCommand {
    ...
    public void CommandSuccess(Player player, String[] args) {
        ...
        EagleVisionAPI.AddLocation(pathName, player.getLocation());
        ChatAPI.SendMessageToPlayer(player, ChatColor.GREEN + "Added Location!", true);
    }
