...
public class DeletePath implements CommandExecutor, PandaCommand {
    ...
    public void CommandSuccess(Player player, String[] args) {
        ...
        EagleVisionAPI.DeletePath(pathName);
        ChatAPI.SendMessageToChannel(player, ChatColor.RED + "You have removed path: " + ChatColor.WHITE + pathName, true);
    }
